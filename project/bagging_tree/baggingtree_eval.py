...
TRAIN_SIZE, SAMPLE_SIZE, TREE_NUM = len(trainlist)-1, int((len(trainlist)-1)*0.2), 101
...
df_eval_data = pd.read_csv(DATA_DIR + 'misc.eval.csv')
print("example_id,label")
eval_data_size = df_eval_data.shape[0]
